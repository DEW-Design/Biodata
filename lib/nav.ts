...
export const rawNav: NavSection[] = [
  ...
  },
  {
    title: "Components",
    items: [
      { title: "Accordion", href: "/components/accordion", description: "Expand/collapse title/content list, animated with a real spring (motion/react) - optional single-open behaviour." },
      ...
      { title: "Dropdown", href: "/components/dropdown", description: "Menu built on React Aria - icon items, sections, and checkmark/checkbox/radio/toggle selection indicators." },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Textarea", href: "/custom-components/textarea", description: "Multi-line text field styled exactly like Input - no real DEW equivalent exists yet. Pending a stakeholder decision on promotion into Components." },
    ],
  },
  {
    title: "Patterns",
