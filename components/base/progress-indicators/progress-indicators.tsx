...
export const ProgressBarBase = ({ value, min = 0, max = 100, className, progressClassName }: ProgressBarProps) => {
    ...
    return (
        <div
            ...
            aria-valuemin={min}
            aria-valuemax={max}
            className={cx("font-barlow h-2 w-full overflow-hidden rounded-md bg-tertiary", className)}
        >
            <div
...
export const ProgressBar = ({ value, min = 0, max = 100, valueFormatter, labelPosition, className, progressClassName }: ProgressIndicatorWithTextProps) => {
    ...
    switch (labelPosition) {
        case "right":
            return (
                <div className="font-barlow flex items-center gap-3">
                    {baseProgressBar}
        ...
        case "bottom":
            return (
                <div className="font-barlow flex flex-col items-end gap-2">
                    {baseProgressBar}
        ...
        case "top-floating":
            return (
                <div className="font-barlow relative flex flex-col items-end gap-2">
                    {baseProgressBar}
                    <div
